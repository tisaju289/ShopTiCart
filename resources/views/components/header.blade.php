                ...
                <div class="col-md-6">
                	<div class="d-flex align-items-center justify-content-center justify-content-md-start">
                        ...
                        <ul class="contact_detail text-center text-lg-start">
                            <li><i class="ti-mobile"></i><span>+8801881-324067</span></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6">
    	...
    	<div class="container">
            <nav class="navbar navbar-expand-lg"> 
                <a class="navbar-brand" href="index.html">
                    <img class="logo_light" src="assets/images/shopticart-logo2.png" alt="logo" />
                    <img class="logo_dark" src="assets/images/shopticart-logo2.png" alt="logo" style="width: 160px"/>
                </a>
