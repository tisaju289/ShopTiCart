<div class="header">
    ...
    <img src="/admin-panel/assets/img/flags/us.png" alt="" height="16"> English
    </a>
    <a href="javascript:void(0);" class="dropdown-item">
    <img src="/admin-panel/assets/img/flags/fr.png" alt="" height="16"> French
    </a>
    <a href="javascript:void(0);" class="dropdown-item">
    <img src="/admin-panel/assets/img/flags/es.png" alt="" height="16"> Spanish
    </a>
    <a href="javascript:void(0);" class="dropdown-item">
    ...
    <img alt="" src="/admin-panel/assets/img/profiles/avatar-02.jpg">
    </span>
    ...
    <div class="media d-flex">
    <span class="avatar flex-shrink-0">
    <img alt="" src="/admin-panel/assets/img/profiles/avatar-03.jpg">
    </span>
    <div class="media-body flex-grow-1">
    ...
    <div class="media d-flex">
    <span class="avatar flex-shrink-0">
    <img alt="" src="/admin-panel/assets/img/profiles/avatar-06.jpg">
    </span>
    <div class="media-body flex-grow-1">
    ...
    <div class="media d-flex">
    <span class="avatar flex-shrink-0">
    <img alt="" src="/admin-panel/assets/img/profiles/avatar-17.jpg">
    </span>
    <div class="media-body flex-grow-1">
    ...
    <div class="media d-flex">
    <span class="avatar flex-shrink-0">
    <img alt="" src="/admin-panel/assets/img/profiles/avatar-13.jpg">
    </span>
    <div class="media-body flex-grow-1">
    ...
    <hr class="m-0">
    <a class="dropdown-item logout pb-0" href="signin.html"><img src="/admin-panel/assets/img/icons/log-out.svg" class="me-2" alt="img">Logout</a>
    </div>
    </div>
    </li>
    </ul>
