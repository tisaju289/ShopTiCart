@extends('super-admin-panel.layouts.app')
                        ...
                        <ul class="divide-y divide-slate-200 dark:divide-zink-500">
                            <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                                <div class="w-8 h-8 rounded-full shrink-0 bg-slate-100 dark:bg-zink-600">
                                    <img src="admin-panel/assets/images/avatar-2.png" alt="" class="w-8 h-8 rounded-full">
                                </div>
                                <div class="grow">
                            ...
                            <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                                <div class="w-8 h-8 rounded-full shrink-0 bg-slate-100 dark:bg-zink-600">
                                    <img src="admin-panel/assets/images/avatar-3.png" alt="" class="w-8 h-8 rounded-full">
                                </div>
                                <div class="grow">
                            ...
                            <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                                <div class="w-8 h-8 rounded-full shrink-0 bg-slate-100 dark:bg-zink-600">
                                    <img src="admin-panel/assets/images/avatar-4.png" alt="" class="w-8 h-8 rounded-full">
                                </div>
                                <div class="grow">
                            ...
                            <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                                <div class="w-8 h-8 rounded-full shrink-0 bg-slate-100 dark:bg-zink-600">
                                    <img src="admin-panel/assets/images/avatar-5.png" alt="" class="w-8 h-8 rounded-full">
                                </div>
                                <div class="grow">
                        ...
                        <ul class="flex flex-col gap-5">
                            <li class="flex items-center gap-3">
                                <div class="flex items-center justify-center w-10 h-10 rounded-md bg-slate-100 dark:bg-zink-600">
                                    <img src="admin-panel/assets/images/img-02.png" alt="" class="h-6">
                                </div>
                            ...
                            <li class="flex items-center gap-3">
                                <div class="flex items-center justify-center w-10 h-10 rounded-md bg-slate-100 dark:bg-zink-600">
                                    <img src="admin-panel/assets/images/img-03.png" alt="" class="h-6">
                                </div>
                                <div class="overflow-hidden grow">
                            ...
                            <li class="flex items-center gap-3">
                                <div class="flex items-center justify-center w-10 h-10 rounded-md bg-slate-100 dark:bg-zink-600">
                                    <img src="admin-panel/assets/images/img-04.png" alt="" class="h-6">
                                </div>
                                <div class="overflow-hidden grow">
                            ...
                            <li class="flex items-center gap-3">
                                <div class="flex items-center justify-center w-10 h-10 rounded-md bg-slate-100 dark:bg-zink-600">
                                    <img src="admin-panel/assets/images/img-05.png" alt="" class="h-6">
                                </div>
                                <div class="overflow-hidden grow">
                            ...
                            <li class="flex items-center gap-3">
                                <div class="flex items-center justify-center w-10 h-10 rounded-md bg-slate-100 dark:bg-zink-600">
                                    <img src="admin-panel/assets/images/img-06.png" alt="" class="h-6">
                                </div>
                                <div class="overflow-hidden grow">
